...
import { AlgoCrustLsigClient } from '../contracts/clients/AlgoCrustLsigClient';

const fixture = algorandFixture();
algokit.Config.configure({ populateAppCallResources: true });

let appClient: AlgoCrustLsigClient;

describe('AlgoCrustLsig', () => {
  ...
  beforeAll(async () => {
    ...
    appClient = new AlgoCrustLsigClient(
      {
        sender: testAccount,
        resolveBy: 'id',
        id: 0,
